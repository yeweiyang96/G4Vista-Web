...
const WORKFLOW_CARDS: readonly WorkflowCard[] = [
  {
    ...
    icon: 'biotech',
    title: 'Find a genome',
    body: 'Search genome assemblies and inspect predicted G4 and i-motif-forming sequences.',
    action: 'Open Genome',
    route: '/genome',
  },
  {
    ...
    icon: 'search',
    title: 'Search genes',
    body: 'Find genes or features and inspect linked predicted G4 and i-motif-forming sequences.',
  ...
  },
  {
    ...
    body: 'Compare microbial traits with G4 density patterns.',
  ...
  },
  {
    ...
    body: 'Browse taxonomic groups and inspect predicted G4 and i-motif-forming sequences.',
